...
var perspective=require("gl-mat4/perspective"),multiply=require("gl-mat4/multiply"),lookAt=require("gl-mat4/lookAt"),invert=require("gl-mat4/invert"),rotate=require("gl-mat4/rotate"),transform=require("gl-vec3/transformMat4"),foxJSON=require("./fox.json"),colors=["#01888C","#FC7500","#034F5D","#F73F01","#FC1960","#C7144C","#F3C100","#1598F2","#2465E1","#F19E02"],MersenneTwister=require("mersenne-twister"),SVG_NS="http://www.w3.org/2000/svg";function createNode(t){return document.createElementNS(SVG_NS,t)}function setAttribute(t,e,n){t.setAttributeNS(null,e,n)}module.exports=function(t){var e,n=t||{},o=!!n.followMouse,r=!!n.followMotion,i=!!n.slowDrift,a=n.colorSeed;a&&(e=new MersenneTwister(a));var l=!0,s=[0,0],u=.3,h=n.width||400,c=n.height||400,f=createNode("svg"),d={x:0,y:0},w=foxJSON.positions.length,g=new Float32Array(3*w),v=new Float32Array(3*w),p=[];function m(t){var e=f.getBoundingClientRect();d.x=1-2*(t.x-e.left)/e.width,d.y=1-2*(t.y-e.top)/e.height}function A(t,e,n){this.svg=t,this.indices=e,this.zIndex=0,this.chunk=n}n.pxNotRatio||(h=window.innerWidth*(n.width||.25)|0,c=0|(window.innerHeight*n.height||h),"minWidth"in n&&h<n.minWidth&&(h=n.minWidth,c=n.minWidth*n.height/n.width|0)),setAttribute(f,"width",h+"px"),setAttribute(f,"height",c+"px"),document.body.appendChild(f),function(){for(var t=foxJSON.positions,e=0,n=0;n<t.length;++n)for(var o=t[n],r=0;r<3;++r)g[e++]=o[r]}();var y=function(){for(var t=[],n=0;n<foxJSON.chunks.length;++n){var o,r=foxJSON.chunks[n];r.polygons||(r.polygons=[]),o=e?colors[Math.floor(e.random()*colors.length)]:"rgb("+r.color+")";for(var i=r.faces,a=0;a<i.length;++a){var l=i[a],s=createNode("polygon");setAttribute(s,"fill",o),setAttribute(s,"stroke",o),setAttribute(s,"points","0,0, 10,0, 0,10"),f.appendChild(s);const e=new A(s,l,r);t.push(e),r.polygons.push(e)}}return t}(),F=function(){var t=new Float32Array(3),e=new Float32Array([0,1,0]),n=new Float32Array(16),o=new Float32Array(16),r=lookAt(new Float32Array(16),new Float32Array([0,0,400]),t,e),a=invert(new Float32Array(16),r),l=new Float32Array(16),u=new Float32Array(3),h=new Float32Array(16),c=new Float32Array([1,0,0]),d=new Float32Array([0,1,0]),w=new Float32Array([0,0,1]);return function(){var g=f.getBoundingClientRect(),v=g.width,p=g.height;if(perspective(n,Math.PI/4,v/p,100,1e3),invert(l,n),u[0]=s[0],u[1]=s[1],u[2]=1.2,transform(u,u,l),transform(u,u,a),lookAt(o,t,u,e),i){var m=Date.now()/1e3;rotate(o,o,.1+.2*Math.sin(m/3),c),rotate(o,o,.03*Math.sin(m/2)-.1,w),rotate(o,o,.5+.2*Math.sin(m/3),d)}return multiply(h,n,r),multiply(h,h,o),h}}();function x(t,e){return e.zIndex-t.zIndex}function M(){l=!1}function N(){l=!0}function b(){if(l){window.requestAnimationFrame(b);var t=1-u;f.getBoundingClientRect();s[0]=t*s[0]+u*d.x,s[1]=t*s[1]+u*d.y+.085,!function(t){for(var e=t[0],n=t[1],o=t[2],r=t[3],i=t[4],a=t[5],l=t[6],s=t[7],u=t[8],h=t[9],c=t[10],f=t[11],d=t[12],p=t[13],m=t[14],A=t[15],y=0;y<w;++y){var F=g[3*y],x=g[3*y+1],M=g[3*y+2],N=F*r+x*s+M*f+A;v[3*y]=(F*e+x*i+M*u+d)/N,v[3*y+1]=(F*n+x*a+M*h+p)/N,v[3*y+2]=(F*o+x*l+M*c+m)/N}}(F()),function(){var t,e=f.getBoundingClientRect(),n=e.width,o=e.height;for(p.length=0,t=0;t<y.length;++t){var r=y[t],i=r.indices,a=i[0],l=i[1],s=i[2],u=v[3*a],h=v[3*a+1],c=v[3*l],d=v[3*l+1],w=v[3*s];if(!((c-u)*(v[3*s+1]-h)-(d-h)*(w-u)<0)){for(var g=[],m=-1/0,A=1/0,F=r.svg,M=0;M<3;++M){var N=i[M];g.push(.5*n*(1-v[3*N])+","+.5*o*(1-v[3*N+1]));var b=v[3*N+2];m=Math.max(m,b),A=Math.min(A,b)}r.zIndex=m+.25*A;var C=g.join(" ");-1===C.indexOf("NaN")&&setAttribute(F,"points",C),p.push(r)}}for(p.sort(x),f.innerHTML="",t=0;t<p.length;++t)f.appendChild(p[t].svg)}(),M()}}return window.addEventListener("mousemove",function(t){l||N(),o&&(m({x:t.clientX,y:t.clientY}),b())}),window.addEventListener("deviceorientation",function(t){if(l||N(),r){const e=10;m({x:200+t.gamma*e,y:-300+t.beta*e}),b()}}),b(),{container:f,lookAt:m,recolor:function(t){var e;t&&(e=new MersenneTwister(t));for(const t of foxJSON.chunks){let n;n=e?colors[Math.floor(e.random()*colors.length)]:"rgb("+t.color+")";for(const e of t.polygons)setAttribute(e.svg,"fill",n),setAttribute(e.svg,"stroke",n)}b()},setFollowMouse:function(t){o=t},setFollowMotion:function(t){r=t},stopAnimation:M,startAnimation:N}};
