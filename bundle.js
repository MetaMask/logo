...
function createNode(t){return document.createElementNS(SVG_NS,t)}function setAttribute(t,e,n){t.setAttributeNS(null,e,n)}var perspective=require("gl-mat4/perspective"),multiply=require("gl-mat4/multiply"),lookAt=require("gl-mat4/lookAt"),invert=require("gl-mat4/invert"),rotate=require("gl-mat4/rotate"),transform=require("gl-vec3/transformMat4"),foxJSON=require("./fox.json"),SVG_NS="http://www.w3.org/2000/svg";module.exports=function(t){function e(t){var e=x.getBoundingClientRect();F.x=1-2*(t.x-e.left)/e.width,F.y=1-2*(t.y-e.top)/e.height}function n(t,e){this.svg=t,this.indices=e,this.zIndex=0}function r(t){for(var e=t[0],n=t[1],r=t[2],i=t[3],o=t[4],a=t[5],l=t[6],u=t[7],s=t[8],h=t[9],f=t[10],d=t[11],c=t[12],w=t[13],g=t[14],v=t[15],A=0;A<N;++A){var m=M[3*A],p=M[3*A+1],y=M[3*A+2],x=m*i+p*u+y*d+v;b[3*A]=(m*e+p*o+y*s+c)/x,b[3*A+1]=(m*n+p*a+y*h+w)/x,b[3*A+2]=(m*r+p*l+y*f+g)/x}}function i(t,e){return e.zIndex-t.zIndex}function o(){var t,e=x.getBoundingClientRect(),n=e.width,r=e.height;for(S.length=0,t=0;t<k.length;++t){var o=k[t],a=o.indices,l=a[0],u=a[1],s=a[2],h=b[3*l],f=b[3*l+1],d=b[3*u],c=b[3*u+1],w=b[3*s];if(!((d-h)*(b[3*s+1]-f)-(c-f)*(w-h)<0)){for(var g=[],v=-1/0,A=1/0,m=o.svg,p=0;p<3;++p){var y=a[p];g.push(.5*n*(1-b[3*y])+","+.5*r*(1-b[3*y+1]));var F=b[3*y+2];v=Math.max(v,F),A=Math.min(A,F)}o.zIndex=v+.25*A;var N=g.join(" ");-1===N.indexOf("NaN")&&setAttribute(m,"points",N),S.push(o)}}for(S.sort(i),x.innerHTML="",t=0;t<S.length;++t)x.appendChild(S[t].svg)}function a(){v=!1}function l(){v=!0}function u(t){c=t}function s(t){w=t}function h(t){e(t),A[0]=F.x,A[1]=F.y+.085/m,r(q()),o(),a()}function f(){if(v){window.requestAnimationFrame(f);var t=1-m;x.getBoundingClientRect();A[0]=t*A[0]+m*F.x,A[1]=t*A[1]+m*F.y+.085;r(q()),o(),a()}}var d=t||{},c=!!d.followMouse,w=!!d.followMotion,g=!!d.slowDrift,v=!0,A=[0,0],m=.3,p=d.width||400,y=d.height||400,x=createNode("svg"),F={x:0,y:0},N=foxJSON.positions.length,M=new Float32Array(3*N),b=new Float32Array(3*N),S=[];d.pxNotRatio||(p=window.innerWidth*(d.width||.25)|0,y=0|(window.innerHeight*d.height||p),"minWidth"in d&&p<d.minWidth&&(p=d.minWidth,y=d.minWidth*d.height/d.width|0)),setAttribute(x,"width",p+"px"),setAttribute(x,"height",y+"px"),document.body.appendChild(x),function(){for(var t=foxJSON.positions,e=0,n=0;n<t.length;++n)for(var r=t[n],i=0;i<3;++i)M[e++]=r[i]}();var k=function(){for(var t=[],e=0;e<foxJSON.chunks.length;++e)for(var r=foxJSON.chunks[e],i="rgb("+r.color+")",o=r.faces,a=0;a<o.length;++a){var l=o[a],u=createNode("polygon");setAttribute(u,"fill",i),setAttribute(u,"stroke",i),setAttribute(u,"points","0,0, 10,0, 0,10"),x.appendChild(u),t.push(new n(u,l))}return t}(),q=function(){var t=new Float32Array(3),e=new Float32Array([0,1,0]),n=new Float32Array(16),r=new Float32Array(16),i=lookAt(new Float32Array(16),new Float32Array([0,0,400]),t,e),o=invert(new Float32Array(16),i),a=new Float32Array(16),l=new Float32Array(3),u=new Float32Array(16),s=new Float32Array([1,0,0]),h=new Float32Array([0,1,0]),f=new Float32Array([0,0,1]);return function(){var d=x.getBoundingClientRect(),c=d.width,w=d.height;if(perspective(n,Math.PI/4,c/w,100,1e3),invert(a,n),l[0]=A[0],l[1]=A[1],l[2]=1.2,transform(l,l,a),transform(l,l,o),lookAt(r,t,l,e),g){var v=Date.now()/1e3;rotate(r,r,.1+.2*Math.sin(v/3),s),rotate(r,r,.03*Math.sin(v/2)-.1,f),rotate(r,r,.5+.2*Math.sin(v/3),h)}return multiply(u,n,i),multiply(u,u,r),u}}();return window.addEventListener("mousemove",function(t){v||l(),c&&(e({x:t.clientX,y:t.clientY}),f())}),window.addEventListener("deviceorientation",function(t){if(v||l(),w){const n=t.gamma,r=t.beta;e({x:200+10*n,y:10*r-300}),f()}}),f(),{container:x,lookAt:e,setFollowMouse:u,setFollowMotion:s,stopAnimation:a,startAnimation:l,lookAtAndRender:h}};
