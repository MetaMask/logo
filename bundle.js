...
var createViewer=require("../index");const colorSeed=Math.floor(1e5*Math.random());window.addEventListener("load",()=>{document.querySelector("button.save").addEventListener("click",saveImage),document.querySelector("button.recolor").addEventListener("click",startRecolor),document.querySelector("button.cycle").addEventListener("click",toggleCycle)});let cycleInterval,cycling=!1;function toggleCycle(){cycling&&cycleInterval?(console.dir(cycleInterval),clearInterval(cycleInterval),cycling=!1):cycling||(cycleInterval=setInterval(recolor,500),cycling=!0)}function saveImage(){download('<!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd"> <svg width="521px" height="521px" version="1.1" baseProfile="full" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:ev="http://www.w3.org/2001/xml-events">'+document.querySelector("svg").innerHTML+"</svg>",`custom-fox-${colorSeed}.svg`,"image/svg+xml")}document.addEventListener("keypress",e=>{99===e.keyCode&&saveImage()});var viewer=createViewer({width:.4,height:.4,followMouse:!0,followMotion:!0});const recolorDuration=5e3;let recolorStartTime=0,recolorRemaining=0;function startRecolor(){console.log("startRecolor"),recolorStartTime=Date.now(),recolorRemaining=recolorDuration,recolor(Math.floor(1e7*Math.random()))}function recolor(e){console.log("recolor",e);const o=Date.now()-recolorStartTime;if((recolorRemaining=recolorDuration-o)<=0)return;const r=(recolorDuration-recolorRemaining)/recolorDuration;console.log("fraction",r),viewer.recolor({colorSeed:e,oddsOfPolygonVisibility:r,colorByBlock:r>.5,randomness:recolorRemaining/recolorDuration}),setTimeout(()=>{window.requestAnimationFrame(()=>recolor(e))},100*r)}const foxDiv=document.querySelector("body div.fox");function download(e,o,r){var t=new Blob([e],{type:r});if(window.navigator.msSaveOrOpenBlob)window.navigator.msSaveOrOpenBlob(t,o);else{var n=document.createElement("a"),c=URL.createObjectURL(t);n.href=c,n.download=o,document.body.appendChild(n),n.click(),setTimeout(function(){document.body.removeChild(n),window.URL.revokeObjectURL(c)},0)}}foxDiv.appendChild(viewer.container);
