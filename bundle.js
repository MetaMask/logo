...
var createViewer=require("../index"),viewer=createViewer({width:.4,height:.4,followMouse:!0});document.body.appendChild(viewer.container);
...
function createNode(t){return document.createElementNS(SVG_NS,t)}function setAttribute(t,e,n){t.setAttributeNS(null,e,n)}var perspective=require("gl-mat4/perspective"),multiply=require("gl-mat4/multiply"),lookAt=require("gl-mat4/lookAt"),invert=require("gl-mat4/invert"),rotate=require("gl-mat4/rotate"),transform=require("gl-vec3/transformMat4"),foxJSON=require("./fox.json"),SVG_NS="http://www.w3.org/2000/svg";module.exports=function(t){function e(t,e){this.svg=t,this.indices=e,this.zIndex=0}function n(t){for(var e=t[0],n=t[1],r=t[2],i=t[3],o=t[4],a=t[5],l=t[6],u=t[7],s=t[8],h=t[9],f=t[10],d=t[11],c=t[12],w=t[13],v=t[14],g=t[15],p=0;x>p;++p){var A=F[3*p],m=F[3*p+1],y=F[3*p+2],S=A*i+m*u+y*d+g;N[3*p]=(A*e+m*o+y*s+c)/S,N[3*p+1]=(A*n+m*a+y*h+w)/S,N[3*p+2]=(A*r+m*l+y*f+v)/S}}function r(t,e){return e.zIndex-t.zIndex}function i(){var t,e=m.getBoundingClientRect(),n=e.width,i=e.height;for(M.length=0,t=0;t<S.length;++t){var o=S[t],a=o.indices,l=a[0],u=a[1],s=a[2],h=N[3*l],f=N[3*l+1],d=N[3*u],c=N[3*u+1],w=N[3*s],v=N[3*s+1],g=(d-h)*(v-f)-(c-f)*(w-h);if(!(0>g)){for(var p=[],A=-(1/0),y=1/0,x=o.svg,F=0;3>F;++F){var b=a[F];p.push(.5*n*(1-N[3*b])+","+.5*i*(1-N[3*b+1]));var k=N[3*b+2];A=Math.max(A,k),y=Math.min(y,k)}o.zIndex=A+.25*y,setAttribute(x,"points",p.join(" ")),M.push(o)}}for(M.sort(r),m.innerHTML="",t=0;t<M.length;++t)m.appendChild(M[t].svg)}function o(){if(c){window.requestAnimationFrame(o);var t=1-g;v[0]=t*v[0]+g*y.x,v[1]=t*v[1]+g*y.y+.085;var e=b();n(e),i()}}function a(){c=!1}function l(){c=!0}function u(t){f=t}function s(t){y.x=t.x,y.y=t.y}var h=t||{},f=!!h.followMouse,d=!!h.slowDrift,c=!0,w=400,v=[0,0],g=.3,p=h.width||400,A=h.height||400,m=createNode("svg");h.pxNotRatio||(p=window.innerWidth*(h.width||.25)|0,A=0|(window.innerHeight*h.height||p),"minWidth"in h&&p<h.minWidth&&(p=h.minWidth,A=h.minWidth*h.height/h.width|0)),setAttribute(m,"width",p+"px"),setAttribute(m,"height",A+"px");var y={x:0,y:0};window.addEventListener("mousemove",function(t){if(f){var e=m.getBoundingClientRect();y.x=1-2*(t.clientX-e.left)/e.width,y.y=1-2*(t.clientY-e.top)/e.height}}),document.body.appendChild(m);var x=foxJSON.positions.length,F=new Float32Array(3*x),N=new Float32Array(3*x);!function(){for(var t=foxJSON.positions,e=0,n=0;n<t.length;++n)for(var r=t[n],i=0;3>i;++i)F[e++]=r[i]}();var S=function(){for(var t=[],n=0;n<foxJSON.chunks.length;++n)for(var r=foxJSON.chunks[n],i="rgb("+r.color+")",o=r.faces,a=0;a<o.length;++a){var l=o[a],u=createNode("polygon");setAttribute(u,"fill",i),setAttribute(u,"stroke",i),setAttribute(u,"points","0,0, 10,0, 0,10"),m.appendChild(u),t.push(new e(u,l))}return t}(),b=function(){var t=new Float32Array(3),e=new Float32Array([0,1,0]),n=new Float32Array(16),r=new Float32Array(16),i=lookAt(new Float32Array(16),new Float32Array([0,0,w]),t,e),o=invert(new Float32Array(16),i),a=new Float32Array(16),l=new Float32Array(3),u=new Float32Array(16),s=new Float32Array([1,0,0]),h=new Float32Array([0,1,0]),f=new Float32Array([0,0,1]);return function(){var c=m.getBoundingClientRect(),w=c.width,g=c.height;if(perspective(n,Math.PI/4,w/g,100,1e3),invert(a,n),l[0]=v[0],l[1]=v[1],l[2]=1.2,transform(l,l,a),transform(l,l,o),lookAt(r,t,l,e),d){var p=Date.now()/1e3;rotate(r,r,.1+.2*Math.sin(p/3),s),rotate(r,r,-.1+.03*Math.sin(p/2),f),rotate(r,r,.5+.2*Math.sin(p/3),h)}return multiply(u,n,i),multiply(u,u,r),u}}(),M=[];return o(),{container:m,lookAt:s,setFollowMouse:u,stopAnimation:a,startAnimation:l}};
