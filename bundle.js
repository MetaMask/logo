...
var perspective=require("gl-mat4/perspective"),multiply=require("gl-mat4/multiply"),lookAt=require("gl-mat4/lookAt"),invert=require("gl-mat4/invert"),rotate=require("gl-mat4/rotate"),transform=require("gl-vec3/transformMat4"),foxJSON=require("./fox.json"),SVG_NS="http://www.w3.org/2000/svg";function createNode(t){return document.createElementNS(SVG_NS,t)}function setAttribute(t,e,n){t.setAttributeNS(null,e,n)}module.exports=function(t){var e=t||{},n=!!e.followMouse,r=!!e.followMotion,i=!!e.slowDrift,o=!0,a=[0,0],l=.3,u=e.width||400,s=e.height||400,h=createNode("svg"),f={x:0,y:0},c=foxJSON.positions.length,d=new Float32Array(3*c);let w=new Float32Array(3*c);var v=new Float32Array(3*c);let g=function(){const t=m(5e3),e=d.length/3,n=1/e;d=w.slice();for(let r=0;r<e;r++){const e=r*n,i=e+n,o=(t-e)/(i-e),a=Math.min(Math.max(o,0),1),l=Math.max(0,r-1),u=d[3*l+0],s=d[3*l+1],h=d[3*l+2],f=3*r+0,c=3*r+1,v=3*r+2;d[f]=u+a*(w[f]-u),d[c]=s+a*(w[c]-s),d[v]=h+a*(w[v]-h)}};function m(t=1e3){return(Math.sin(Date.now()/t)+1)/2}var A=[];function p(t){var e=h.getBoundingClientRect();f.x=1-2*(t.x-e.left)/e.width,f.y=1-2*(t.y-e.top)/e.height}function y(t,e){this.svg=t,this.indices=e,this.zIndex=0}e.pxNotRatio||(u=window.innerWidth*(e.width||.25)|0,s=0|(window.innerHeight*e.height||u),"minWidth"in e&&u<e.minWidth&&(u=e.minWidth,s=e.minWidth*e.height/e.width|0)),setAttribute(h,"width",u+"px"),setAttribute(h,"height",s+"px"),document.body.appendChild(h),function(){for(var t=foxJSON.positions,e=0,n=0;n<t.length;++n)for(var r=t[n],i=0;i<3;++i)d[e++]=r[i]}(),w=d.slice();var x=function(){for(var t=[],e=0;e<foxJSON.chunks.length;++e)for(var n=foxJSON.chunks[e],r="rgb("+n.color+")",i=n.faces,o=0;o<i.length;++o){var a=i[o],l=createNode("polygon");setAttribute(l,"fill",r),setAttribute(l,"stroke",r),setAttribute(l,"points","0,0, 10,0, 0,10"),h.appendChild(l),t.push(new y(l,a))}return t}(),F=function(){var t=new Float32Array(3),e=new Float32Array([0,1,0]),n=new Float32Array(16),r=new Float32Array(16),o=lookAt(new Float32Array(16),new Float32Array([0,0,400]),t,e),l=invert(new Float32Array(16),o),u=new Float32Array(16),s=new Float32Array(3),f=new Float32Array(16),c=new Float32Array([1,0,0]),d=new Float32Array([0,1,0]),w=new Float32Array([0,0,1]);return function(){var v=h.getBoundingClientRect(),g=v.width,m=v.height;if(perspective(n,Math.PI/4,g/m,100,1e3),invert(u,n),s[0]=a[0],s[1]=a[1],s[2]=1.2,transform(s,s,u),transform(s,s,l),lookAt(r,t,s,e),i){var A=Date.now()/1e3;rotate(r,r,.1+.2*Math.sin(A/3),c),rotate(r,r,.03*Math.sin(A/2)-.1,w),rotate(r,r,.5+.2*Math.sin(A/3),d)}return multiply(f,n,o),multiply(f,f,r),f}}();function M(t,e){return e.zIndex-t.zIndex}function N(){o=!0}function b(){if(o){window.requestAnimationFrame(b),g();var t=1-l;h.getBoundingClientRect();a[0]=t*a[0]+l*f.x,a[1]=t*a[1]+l*f.y+.085,!function(t){for(var e=t[0],n=t[1],r=t[2],i=t[3],o=t[4],a=t[5],l=t[6],u=t[7],s=t[8],h=t[9],f=t[10],w=t[11],g=t[12],m=t[13],A=t[14],p=t[15],y=0;y<c;++y){var x=d[3*y],F=d[3*y+1],M=d[3*y+2],N=x*i+F*u+M*w+p;v[3*y]=(x*e+F*o+M*s+g)/N,v[3*y+1]=(x*n+F*a+M*h+m)/N,v[3*y+2]=(x*r+F*l+M*f+A)/N}}(F()),function(){var t,e=h.getBoundingClientRect(),n=e.width,r=e.height;for(A.length=0,t=0;t<x.length;++t){var i=x[t],o=i.indices,a=o[0],l=o[1],u=o[2],s=v[3*a],f=v[3*a+1],c=v[3*l],d=v[3*l+1],w=v[3*u];if(!((c-s)*(v[3*u+1]-f)-(d-f)*(w-s)<0)){for(var g=[],m=-1/0,p=1/0,y=i.svg,F=0;F<3;++F){var N=o[F];g.push(.5*n*(1-v[3*N])+","+.5*r*(1-v[3*N+1]));var b=v[3*N+2];m=Math.max(m,b),p=Math.min(p,b)}i.zIndex=m+.25*p;var S=g.join(" ");-1===S.indexOf("NaN")&&setAttribute(y,"points",S),A.push(i)}}for(A.sort(M),h.innerHTML="",t=0;t<A.length;++t)h.appendChild(A[t].svg)}()}}return window.addEventListener("mousemove",function(t){o||N(),n&&(p({x:t.clientX,y:t.clientY}),b())}),window.addEventListener("deviceorientation",function(t){if(o||N(),r){const e=10;p({x:200+t.gamma*e,y:-300+t.beta*e}),b()}}),b(),{container:h,lookAt:p,setFollowMouse:function(t){n=t},setFollowMotion:function(t){r=t},stopAnimation:function(){o=!1},startAnimation:N}};
