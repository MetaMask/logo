...
var perspective=require("gl-mat4/perspective"),multiply=require("gl-mat4/multiply"),lookAt=require("gl-mat4/lookAt"),invert=require("gl-mat4/invert"),rotate=require("gl-mat4/rotate"),transform=require("gl-vec3/transformMat4"),foxJSON=require("./fox.json"),colors=["#01888C","#FC7500","#034F5D","#F73F01","#FC1960","#C7144C","#F3C100","#1598F2","#2465E1","#F19E02"],MersenneTwister=require("mersenne-twister"),SVG_NS="http://www.w3.org/2000/svg";function createNode(t){return document.createElementNS(SVG_NS,t)}function setAttribute(t,e,o){t.setAttributeNS(null,e,o)}module.exports=function(t){var e,o=t||{},n=!!o.followMouse,r=!!o.slowDrift,a=o.colorSeed;a&&(e=new MersenneTwister(a));var l=!0,s=[0,0],c=.3,u=o.width||400,d=o.height||400,h=createNode("svg"),f={x:0,y:0},w=foxJSON.positions.length,g=new Float32Array(3*w),v=new Float32Array(3*w),m=[];const y=o.recolorDuration||12e3;let p=0,A=0;function F(t){var e=h.getBoundingClientRect();f.x=1-2*(t.x-e.left)/e.width,f.y=1-2*(t.y-e.top)/e.height}function M(t,e,o){this.svg=t,this.indices=e,this.zIndex=0,this.chunk=o}o.pxNotRatio||(u=window.innerWidth*(o.width||.25)|0,d=0|(window.innerHeight*o.height||u),"minWidth"in o&&u<o.minWidth&&(u=o.minWidth,d=o.minWidth*o.height/o.width|0)),setAttribute(h,"width",u+"px"),setAttribute(h,"height",d+"px"),document.body.appendChild(h),function(){for(var t=foxJSON.positions,e=0,o=0;o<t.length;++o)for(var n=t[o],r=0;r<3;++r)g[e++]=n[r]}();var x=function(t=[]){for(var o=[],n=0;n<foxJSON.chunks.length;++n){var r,i=foxJSON.chunks[n],a=t[n]?t[n]:i.color;i.polygons||(i.polygons=[]),r=e?t[Math.floor(e.random()*t.length)]:"rgb("+a+")";for(var l=i.faces,s=0;s<l.length;++s){var c=l[s],u=createNode("polygon");setAttribute(u,"fill",r),setAttribute(u,"stroke",r),setAttribute(u,"points","0,0, 10,0, 0,10"),h.appendChild(u);const t=new M(u,c,i);o.push(t),i.polygons.push(t)}}return o}(o.colors),b=function(){var t=new Float32Array(3),e=new Float32Array([0,1,0]),o=new Float32Array(16),n=new Float32Array(16),i=lookAt(new Float32Array(16),new Float32Array([0,0,400]),t,e),a=invert(new Float32Array(16),i),l=new Float32Array(16),c=new Float32Array(3),u=new Float32Array(16),d=new Float32Array([1,0,0]),f=new Float32Array([0,1,0]),w=new Float32Array([0,0,1]);return function(){var g=h.getBoundingClientRect(),v=g.width,m=g.height;if(perspective(o,Math.PI/4,v/m,100,1e3),invert(l,o),c[0]=s[0],c[1]=s[1],c[2]=1.2,transform(c,c,l),transform(c,c,a),lookAt(n,t,c,e),r){var y=Date.now()/1e3;rotate(n,n,.1+.2*Math.sin(y/3),d),rotate(n,n,.03*Math.sin(y/2)-.1,w),rotate(n,n,.5+.2*Math.sin(y/3),f)}return multiply(u,o,i),multiply(u,u,n),u}}();function S(t,e){return e.zIndex-t.zIndex}function N(){l=!1}function k(){l=!0}function C(){if(l){window.requestAnimationFrame(C);var t=1-c;h.getBoundingClientRect();s[0]=t*s[0]+c*f.x,s[1]=t*s[1]+c*f.y+.085,!function(t){for(var e=t[0],o=t[1],n=t[2],r=t[3],i=t[4],a=t[5],l=t[6],s=t[7],c=t[8],u=t[9],d=t[10],h=t[11],f=t[12],m=t[13],y=t[14],p=t[15],A=0;A<w;++A){var F=g[3*A],M=g[3*A+1],x=g[3*A+2],b=F*r+M*s+x*h+p;v[3*A]=(F*e+M*i+x*c+f)/b,v[3*A+1]=(F*o+M*a+x*u+m)/b,v[3*A+2]=(F*n+M*l+x*d+y)/b}}(b()),function(t){var e,o=h.getBoundingClientRect(),n=o.width,r=o.height;for(m.length=0,t=t||x,e=0;e<t.length;++e){var i=t[e],a=i.indices,l=a[0],s=a[1],c=a[2],u=v[3*l],d=v[3*l+1],f=v[3*s],w=v[3*s+1],g=v[3*c];if(!((f-u)*(v[3*c+1]-d)-(w-d)*(g-u)<0)){for(var y=[],p=-1/0,A=1/0,F=i.svg,M=0;M<3;++M){var b=a[M];y.push(.5*n*(1-v[3*b])+","+.5*r*(1-v[3*b+1]));var N=v[3*b+2];p=Math.max(p,N),A=Math.min(A,N)}i.zIndex=p+.25*A;var k=y.join(" ");-1===k.indexOf("NaN")&&setAttribute(F,"points",k),m.push(i)}}for(m.sort(S),h.innerHTML="",e=0;e<m.length;++e)h.appendChild(m[e].svg)}(x),N()}}return window.addEventListener("mousemove",function(t){l||k(),n&&(F({x:t.clientX,y:t.clientY}),C())}),window.addEventListener("deviceorientation",function(t){if(l||k(),followMotion){const e=10;F({x:200+t.gamma*e,y:-300+t.beta*e}),C()}}),C(),{container:h,lookAt:F,setFollowMouse:function(t){n=t},stopAnimation:N,startAnimation:k,reRender:function(t){const{colorSeed:e,oddsOfPolygonVisibility:o,colorByBlock:n,randomness:r}=t,a=t.colors||colors;var l;e&&(l=new MersenneTwister(e));for(const t of foxJSON.chunks){let e,n;if(l)e=a[Math.floor(l.random()*a.length)];else{var s=a[i]?a[i]:t.color;t.polygons||(t.polygons=[]),e="rgb("+s+")"}for(const i of t.polygons){n=void 0!==o&&o<1&&Math.random()>o?"0.0":"1",setAttribute(i.svg,"opacity",n);let t=e;r&&Math.random()<r&&(t=a[Math.floor(Math.random()*a.length)]),setAttribute(i.svg,"fill",t),setAttribute(i.svg,"stroke",t)}}C()},dramaticReveal:function(t){viewer.reRender({...t,oddsOfPolygonVisibility:0}),p=Date.now(),A=y,function t(e){e.colorSeed;const o=Date.now()-p;if((A=y-o)<=0)return viewer.reRender(e);const n=(y-A)/y,r=n<.5,i=r?0:1,a=(Math.cos(n*Math.PI)/-2+.5+i)/2;viewer.reRender({colorSeed:e.colorSeed,colors:e.colors,oddsOfPolygonVisibility:a,colorByBlock:n>.5,randomness:A/y});const l=150*(Math.cos(n*Math.PI*2)/2+.5);setTimeout(()=>{window.requestAnimationFrame(()=>t(e))},l)}(t)}}};
