...
var createViewer=require("../index");const colorSeed=Math.floor(1e5*Math.random());function saveImage(){download('<!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd"> <svg width="521px" height="521px" version="1.1" baseProfile="full" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:ev="http://www.w3.org/2001/xml-events">'+document.querySelector("svg").innerHTML+"</svg>",`custom-fox-${colorSeed}.svg`,"image/svg+xml")}window.addEventListener("load",()=>{document.querySelector("button.save").addEventListener("click",saveImage),document.querySelector("button.recolor").addEventListener("click",startRecolor)}),document.addEventListener("keypress",o=>{99===o.keyCode&&saveImage()});var viewer=createViewer({width:.4,height:.4,followMouse:!0,followMotion:!0});const recolorDuration=12e3;let recolorStartTime=0,recolorRemaining=0;function startRecolor(){const o=Math.floor(1e7*Math.random());viewer.recolor({colorSeed:o,oddsOfPolygonVisibility:0}),recolorStartTime=Date.now(),recolorRemaining=recolorDuration,recolor(o)}function recolor(o){const e=Date.now()-recolorStartTime;if((recolorRemaining=recolorDuration-e)<=0)return viewer.recolor({colorSeed:o});const r=(recolorDuration-recolorRemaining)/recolorDuration,t=r<.5?0:1,n=(Math.cos(r*Math.PI)/-2+.5+t)/2;console.log("odds of visibility",n),viewer.recolor({colorSeed:o,oddsOfPolygonVisibility:n,colorByBlock:r>.5,randomness:recolorRemaining/recolorDuration});const i=150*(Math.cos(r*Math.PI*2)/2+.5);console.log({delay:i,fractionComplete:r}),setTimeout(()=>{window.requestAnimationFrame(()=>recolor(o))},i)}const foxDiv=document.querySelector("body div.fox");function download(o,e,r){var t=new Blob([o],{type:r});if(window.navigator.msSaveOrOpenBlob)window.navigator.msSaveOrOpenBlob(t,e);else{var n=document.createElement("a"),i=URL.createObjectURL(t);n.href=i,n.download=e,document.body.appendChild(n),n.click(),setTimeout(function(){document.body.removeChild(n),window.URL.revokeObjectURL(i)},0)}}foxDiv.appendChild(viewer.container);
