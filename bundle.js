...
var perspective=require("gl-mat4/perspective"),multiply=require("gl-mat4/multiply"),lookAt=require("gl-mat4/lookAt"),invert=require("gl-mat4/invert"),rotate=require("gl-mat4/rotate"),transform=require("gl-vec3/transformMat4"),foxJSON=require("./fox.json"),SVG_NS="http://www.w3.org/2000/svg";function createNode(t){return document.createElementNS(SVG_NS,t)}function setAttribute(t,e,n){t.setAttributeNS(null,e,n)}module.exports=function(t){var e=t||{},n=!!e.followMouse,r=!!e.followMotion,i=!!e.slowDrift,o=!0,a=[0,0],l=.3,u=e.width||400,s=e.height||400,f=createNode("svg"),h={x:0,y:0},c=foxJSON.positions.length,d=new Float32Array(3*c),w=new Float32Array(3*c),v=[];function g(t){var e=f.getBoundingClientRect();h.x=1-2*(t.x-e.left)/e.width,h.y=1-2*(t.y-e.top)/e.height}function m(t,e){this.svg=t,this.indices=e,this.zIndex=0}e.pxNotRatio||(u=window.innerWidth*(e.width||.25)|0,s=0|(window.innerHeight*e.height||u),"minWidth"in e&&u<e.minWidth&&(u=e.minWidth,s=e.minWidth*e.height/e.width|0)),setAttribute(f,"width",u+"px"),setAttribute(f,"height",s+"px"),document.body.appendChild(f),function(){for(var t=foxJSON.positions,e=0,n=0;n<t.length;++n)for(var r=t[n],i=0;i<3;++i)d[e++]=r[i]}();var p=function(){for(var t=[],e=0;e<foxJSON.chunks.length;++e)for(var n=foxJSON.chunks[e],r="rgb("+n.color+")",i=n.faces,o=0;o<i.length;++o){var a=i[o],l=createNode("polygon");setAttribute(l,"fill",r),setAttribute(l,"stroke",r),setAttribute(l,"points","0,0, 10,0, 0,10"),f.appendChild(l),t.push(new m(l,a))}return t}(),A=function(){var t=new Float32Array(3),e=new Float32Array([0,1,0]),n=new Float32Array(16),r=new Float32Array(16),o=lookAt(new Float32Array(16),new Float32Array([0,0,400]),t,e),l=invert(new Float32Array(16),o),u=new Float32Array(16),s=new Float32Array(3),h=new Float32Array(16),c=new Float32Array([1,0,0]),d=new Float32Array([0,1,0]),w=new Float32Array([0,0,1]);return function(){var v=f.getBoundingClientRect(),g=v.width,m=v.height;if(perspective(n,Math.PI/4,g/m,100,1e3),invert(u,n),s[0]=a[0],s[1]=a[1],s[2]=1.2,transform(s,s,u),transform(s,s,l),lookAt(r,t,s,e),i){var p=Date.now()/1e3;rotate(r,r,.1+.2*Math.sin(p/3),c),rotate(r,r,.03*Math.sin(p/2)-.1,w),rotate(r,r,.5+.2*Math.sin(p/3),d)}return multiply(h,n,o),multiply(h,h,r),h}}();function y(t,e){return e.zIndex-t.zIndex}function x(){o=!1}function F(){o=!0}function N(t){if(t||o){window.requestAnimationFrame(N);var e=1-l;f.getBoundingClientRect();a[0]=e*a[0]+l*h.x,a[1]=e*a[1]+l*h.y+.085,!function(t){for(var e=t[0],n=t[1],r=t[2],i=t[3],o=t[4],a=t[5],l=t[6],u=t[7],s=t[8],f=t[9],h=t[10],v=t[11],g=t[12],m=t[13],p=t[14],A=t[15],y=0;y<c;++y){var x=d[3*y],F=d[3*y+1],N=d[3*y+2],M=x*i+F*u+N*v+A;w[3*y]=(x*e+F*o+N*s+g)/M,w[3*y+1]=(x*n+F*a+N*f+m)/M,w[3*y+2]=(x*r+F*l+N*h+p)/M}}(A()),function(){var t,e=f.getBoundingClientRect(),n=e.width,r=e.height;for(v.length=0,t=0;t<p.length;++t){var i=p[t],o=i.indices,a=o[0],l=o[1],u=o[2],s=w[3*a],h=w[3*a+1],c=w[3*l],d=w[3*l+1],g=w[3*u];if(!((c-s)*(w[3*u+1]-h)-(d-h)*(g-s)<0)){for(var m=[],A=-1/0,x=1/0,F=i.svg,N=0;N<3;++N){var M=o[N];m.push(.5*n*(1-w[3*M])+","+.5*r*(1-w[3*M+1]));var S=w[3*M+2];A=Math.max(A,S),x=Math.min(x,S)}i.zIndex=A+.25*x;var b=m.join(" ");-1===b.indexOf("NaN")&&setAttribute(F,"points",b),v.push(i)}}for(v.sort(y),f.innerHTML="",t=0;t<v.length;++t)f.appendChild(v[t].svg)}(),x()}}return window.addEventListener("mousemove",function(t){o||F(),n&&(g({x:t.clientX,y:t.clientY}),N())}),window.addEventListener("deviceorientation",function(t){if(o||F(),r){const t=event.gamma,e=event.beta;yOffset=-300,acceleration=10,g({x:200+t*acceleration,y:yOffset+e*acceleration}),N()}}),N(),{container:f,lookAt:g,setFollowMouse:function(t){n=t},setFollowMotion:function(t){r=t},stopAnimation:x,startAnimation:F,renderScene:N}};
